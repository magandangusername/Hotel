        ...
        <div class="container px-5 py-3">
            ...
            <div class="row mt-4 text-center">
                <div class="col">
                    ...
                    <input type="submit" name="checkavail" id="roomcheck" class="btn btn-outline-dark fw-bold"
                ...
                @foreach ($newpromos as $newpromo)
                    <div class="col p-1">
                        ...
                        <div class="jumbotron text-white jumbotron-image shadow preffer text-center">
                            ...
                            <a href="{{ route('promo') }}/{{ $newpromo->promotion_name }}"
                                class="btn btn-primary m-5">View More</a>
                        </div>
