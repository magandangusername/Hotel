<?php
try {
    // if (!isset($_GET['room']) || !isset($_GET['suite'])) {
        ...
        <div class="col-lg-11 mx-auto d-block">
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <?php
                    $photos = "SELECT p.photo_name
                    FROM gallery_photos p
                    INNER JOIN gallery_albums a
                    ON a.album_id = p.album_id
                    WHERE a.album_name = '$room_name' ";
                    ...
                    <div class="carousel-item <?php if($counter == 1) {
                        ...
                        <img src="photos/<?php echo $photo['photo_name'] ?>" class="d-block w-100" alt="...">
                    </div>
